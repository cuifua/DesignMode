package G_PrototypeMode.now;

import G_PrototypeMode.now.Order.OrderApi;
import G_PrototypeMode.now.Order.PersonalOrder;

/**
 * 原型实例和克隆出来的实例的区别
 * 【说明克隆后新的值和原型不一样，指向的不是同一个地址，即这种方法的克隆不会覆盖原来的数据，是新辟的空间】
 */
public class ClientContrast
{
